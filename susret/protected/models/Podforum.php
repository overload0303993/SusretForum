...
/**
 * This is the model class for table "podforum".
 *
 * The followings are the available columns in table 'podforum':
 * @property integer $id
...
class Podforum extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('naziv, slika', 'required'),
			array('naziv, slika', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, naziv, slika', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Podforum the static model class
	 */
